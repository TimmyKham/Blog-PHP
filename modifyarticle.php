  ...
  <?php
    try {
        ...
        while ($tabArticle = $select->fetch()) {
          ...
          echo "id : "."<b>".$tabArticle[0]."</b>"." Titre :"."<b>".$tabArticle[1]."</b>"." Date :"."<b>".$tabArticle[3]."</b>"." Gros titre :"."<b>".$tabArticle[4]."</b>"." Description : "."<b>".$tabArticle[5]."</b>"."<a href='supparticle.php?id_article=".$tabArticle[0]."'>Supprimer</a><br>";
        }
