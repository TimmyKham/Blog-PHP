  ...
  <?php
    try {
        ...
        while ($tabAccount = $select->fetch()) {
          ...
          echo "id : "."<b>".$tabAccount[0]."</b>"." Nom :"."<b>".$tabAccount[1]."</b>"." Prenom : "."<b>".$tabAccount[2]."</b>"." Date de naissance :"."<b>".$tabAccount[3]."</b>"." Email :"."<b>".$tabAccount[4]."</b>"." Mot de passe : "."<b>".$tabAccount[5]."</b>"." Profil : "."<b>".$tabAccount[6]."</b>"."<a href='suppaccount.php?id=".$tabAccount[0]."'>Supprimer</a><br>";
        }
